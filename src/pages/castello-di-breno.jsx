...
class CastelloDiBreno extends React.Component {
  componentDidMount () {
    // axios.get('../images')
  ...
  render () {
    ...
    return (
      <div>
        <Helmet>
          <title>Webcam Castello di Breno</title>
        ...
        <section className='section nodes bigImage'>
          <div className='section_wrapper'>
            <div className='wrapper_tagline'>
              <h5 className='bold'>Castello di Breno</h5>
            </div>
...
export default CastelloDiBreno

export const pageQuery = graphql`
query CastelloDiBrenoQuery {
  site {
    siteMetadata {
      title
      subtitle
