...
class RifugioLaMaralsina extends React.Component {
  componentDidMount () {
    // axios.get('../images')
  ...
  render () {
    ...
    return (
      <div>
        <Helmet>
          <title>Webcam | Rifugio la Maralsina</title>
        ...
        <section className='section nodes bigImage'>
          <div className='section_wrapper'>
            <div className='wrapper_tagline'>
              <h5 className='bold'>Rifugio la Maralsina</h5>
            </div>
...
Consider a donation in Euro or FairCoin https://www.fairkom.eu/en/sponsoring#Donations for disk space and new features. Virtual hug guaranteed! </p>
        ...
        <BigImage pin={[45.955497, 10.297552]} title={'Dove si trova'} />
        <Footer
        />
      </div>
    );
...
export default RifugioLaMaralsina

export const pageQuery = graphql`
query RifugioLaMaralsinaQuery {
  site {
    siteMetadata {
      title
      subtitle
